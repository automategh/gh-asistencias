            ...
            <div className='px-12 py-16 space-y-10 mx-auto'>
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl">
                    ...
                    <div
                        ...
                        <div className="mt-8 bg-[#f3f4f3] hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] hover:border-b-emerald-900 hover:border-b-2 rounded-3xl p-6 border border-zinc-100/50 transition-all duration-400 ease-out">
